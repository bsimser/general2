...
//            }
            ...
            if (JsonSerializerObsolete.currentRootType.IsAssignableFrom(type))
            {
//                DevdogLogger.LogWarning("Given type " + type + " is assignable to " + JsonSerializerObsolete.currentRootType + " (the current object). This would create an infinite serialization loop. Wrap the variable in Asset<> to avoid this. (serialization ignored)");
                return false;
            }
